...
/**
 * Class representing an immutable tuple of 2 elements. The objects stored in
...
public class Tuple2<F, S> implements Comparable<Tuple2<F, S>>, Serializable{
	...
	private static final long serialVersionUID=4044124433076125459L;
	//************
	/**
	 * The first element.
	 */
	...
	/**
	 * Constructs a {@code Tuple2} with the specified elements.
	 *
	...
	/**
	 * Getter of the first element of this {@code Tuple2}.
	 *
	...
	/**
	 * Getter of the second element of this {@code Tuple2}.
	 *
	 ...
	 * returned, and the comparison of the second elements is returned
	 * otherwise.</p>
	 *
	 ...
	 * are considered equal if both are {@code Tuple2} and the i-th element of
	 * this tuple and the i-th element of the compared tuple are equal, for
	 * any 1&le;i&le;2. Equality is determined with
	...
	/**
	 * Returns a hashCode value for this {@code Tuple2}.
	 *
	...
	public int hashCode(){
		int hash=5;
		hash=13 * hash + Objects.hashCode(this.getFirst());
		hash=13 * hash + Objects.hashCode(this.getSecond());
		return hash;
	}

	/**
	 * Returns a {@code String} representation of this {@code Tuple2}.
	 *
...
/**
 * Tuple2 that gets its data from another tuple.
 */
class BackedTuple2<F, S> extends Tuple2<F, S>{

	private static final long serialVersionUID=491064912674139649L;
	private BackedTuple tuple;

	public BackedTuple2(BackedTuple tuple){
		this.tuple=tuple;
	}
